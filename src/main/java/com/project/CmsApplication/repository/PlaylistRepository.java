...
public interface PlaylistRepository extends JpaRepository<Playlist, Integer> {
    ...
    @Query(value = "INSERT INTO cms.Playlist(status,playlist_name,branch_id,position_id,resource_id,start_date,end_date,\"sort\",created_by,created_date,updated_by,updated_date) " +
            "VALUES('active',:playlist_name,:branch_id,:position_id,:resource_id,CAST(:start_date AS timestamp),CAST(:end_date AS timestamp),:sort,:created_by,current_timestamp,:created_by,current_timestamp)", nativeQuery = true)
